<html lang="en">
    <header>
        ...
        <div class="hero-image">
          <div class="hero-text">
            <h1 style="font-size:50px">Save Our Plant</h1>
            ...
            <div class="row" style="padding-right: 50px; padding-left: 50px;">
                <div class="col-sm-4">
                    <div class="card">
                        ...
                        <div style="padding: 0 16px">
                            <h4 id="cardDetails">Amazon Has Burnt Down Again</h4>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        ...
                        <div style="padding: 0 16px">
                            <h4 id="cardDetails">Trump Is An Idiot</h4>
                            <p id="cardDetails">jashdvjha ajshdva sdjhasjd a sdhabsdjjaks d s a sdasbabs a sda as da  d</p>
                            <button type="button" class="btn btn-primary" style="margin-bottom: 10px;">Read More</button>
                        </div>
                    </div>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        ...
                        <div style="padding: 0 16px">
                            <h4 id="cardDetails">Australia Is Enforcing Laws Against Coal</h4>
